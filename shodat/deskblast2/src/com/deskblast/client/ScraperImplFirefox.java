...
public class ScraperImplFirefox extends ScraperImplDefault{
	...
	private static final String PLUGIN_NAME = "deskblast plugin";
	...
	private final native void insertEmbedImpl(String baseUrl, String host, String port,
		...
		var content = '<EMBED id="' + scraperId + '" name="Deskblast" WIDTH=2 HEIGHT=2 ' 
			+ ' type="application/deskblast-plugin" '
			+ ' blastId="' + blastId + '"'
			+ ' blasterId="' + blasterId + '"'
			+ ' key="' + key + '"'
			+ ' host="' + host + '"'
	...
	static private class InstallDialog extends DialogBox {
	    ...
	    public InstallDialog(final ScraperParms scraperParms) {
	      setText("Deskblast Plugin Install");
	      ...
	      p.setHeight("6em");
	      p.setWidth("18em");
	      p.addNorth(new HTML("To share your desktop, Deskblast needs to install a small plugin.  To continue, click 'OK'"), 4);
