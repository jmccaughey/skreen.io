...
{   
  trace(LOG_NAME, "NPP_New\n");
  trace(LOG_NAME, "compiled at "); trace(LOG_NAME, __TIME__); trace(LOG_NAME, " on "); trace(LOG_NAME, __DATE__); trace(LOG_NAME, "\n");
  if(instance == NULL)
...
{
    trace(LOG_NAME, "NPP_GetValue\n");
    char buff[128];
    sprintf(buff, "variable: %d\n", variable);
    trace(LOG_NAME, buff);
    switch(variable) {
	    case NPPVpluginNameString: {
	        trace(LOG_NAME, "NPP_GetValue(NPPVpluginNameString)\n");
	      *((char **)value) = (char *)"shodat screen showing";
	      break;
	    }
	    case NPPVpluginDescriptionString: {
	        trace(LOG_NAME, "NPP_GetValue(NPPVpluginDescriptionString)\n");
	    ...
	    default: {
	        trace(LOG_NAME, "NPP_GetValue(unknown)\n");
