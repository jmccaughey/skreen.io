					   ...
					   )       //   Type lib ID
{
	...
	GuidUtil::CLSIDtochar(clsid, szCLSID, sizeof(szCLSID)) ;
	...
	else
	{
		...
		setValue(szKeyInProc, "ThreadingModel", "Free") ;
	}
					  ...
					  )       //   Type lib ID
{
	...
	char szLIBID[CLSID_STRING_SIZE] ;
	//LSIDtochar(libid, szLIBID, sizeof(szLIBID)) ;
